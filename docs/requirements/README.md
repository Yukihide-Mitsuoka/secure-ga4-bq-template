...
| [requirements-service-packaging.md](requirements-service-packaging.md) | Service packaging: evidenced common core + 3 standard presets, conditional options, pricing rationale, proposal-draft AI (deterministic preset detection → LLM fills text) | v1.1 draft |
