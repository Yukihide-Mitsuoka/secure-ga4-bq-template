...
| Active work | ADR-0014 grandchild migration is active in Issue #282. PR #289 advances checkpoint 7 to `7f420ea` after merged PR #288 while protecting the direct parent's own foundation lock and decision log. Continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay, migrate the leaf profile to schema v2, and activate its adapter. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [PR #289](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/289), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
