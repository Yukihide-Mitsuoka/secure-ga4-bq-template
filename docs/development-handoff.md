...
| Direct parent lock | `terraform-gcp-template` at `1c13ce6fe8609531816a8f86e8cfcbdb9e4bac0f` | [Inheritance lock](../.github/inheritance/lock.json) |
...
| Active work | ADR-0014 grandchild migration is active in Issue #282. Checkpoint 3 advances the lock to `1c13ce6` after merged PR #284 while protecting the direct parent's repository-local manifest v2 proving slice; continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay and migrate the leaf profile to schema v2. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [PR #284](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/284), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
...
> `1c13ce6fe8609531816a8f86e8cfcbdb9e4bac0f`. Continue Issue #282 one
