...
| Item | State on 2026-07-29 | Evidence or source |
|------|---------------------|--------------------|
...
| Direct parent lock | `terraform-gcp-template` at `2e2b516189c28de72e9b930318a36b5bdb3085c7` | [Inheritance lock](../.github/inheritance/lock.json) |
...
| Active work | Direct-parent inheritance is complete: PR #274 merged, `make doctor` passed on `main`, and the planner reported `up_to_date` with zero pending paths. PR #275 closes the handoff state before Issue #263 closes. | [Issue #263](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/263), [PR #274](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/274), [PR #275](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/275), [Inheritance contract](../.github/inheritance/README.md) |
...
> `2e2b516189c28de72e9b930318a36b5bdb3085c7`. Keep the child-specific governance
