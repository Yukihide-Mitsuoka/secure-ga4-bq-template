...
| Direct parent lock | `terraform-gcp-template` at `4e9907475325b7d70e780949d230fe1935cad5bb` | [Inheritance lock](../.github/inheritance/lock.json) |
...
| Active work | ADR-0014 grandchild migration is active in Issue #282. Checkpoint 4 advances the lock to `4e99074` after merged PR #285; the accepted inherited content is already current and secure-ga4's three context-budget paths remain protected. Continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay and migrate the leaf profile to schema v2. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [PR #285](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/285), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
...
> `4e9907475325b7d70e780949d230fe1935cad5bb`. Continue Issue #282 one
