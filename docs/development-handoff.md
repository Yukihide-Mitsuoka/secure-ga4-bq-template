...
| Direct parent lock | `terraform-gcp-template` at `b47310e537869b329954f4e7b3a245e313f38f08` | [Inheritance lock](../.github/inheritance/lock.json) |
...
| Active work | ADR-0014 grandchild migration is active in Issue #282. Checkpoint 10 advances the direct-parent lock to `b47310e` after merged PR #291 while protecting the direct parent's own foundation lock and decision log. Continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay, migrate the leaf profile to schema v2, and activate its adapter. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
...
> `b47310e537869b329954f4e7b3a245e313f38f08`. Continue Issue #282 one
