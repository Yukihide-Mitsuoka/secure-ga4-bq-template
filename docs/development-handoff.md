...
| Direct parent lock | `terraform-gcp-template` at `037d38ac49ac614302ac099814101ee14241a316` | [Inheritance lock](../.github/inheritance/lock.json) |
...
| Active work | ADR-0014 grandchild migration is active in Issue #282. Checkpoint 6 advances the lock to Terraform release `037d38a` after merged PR #287 while preserving the leaf's independent release history. Continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay, migrate the leaf profile to schema v2, and activate its adapter. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [PR #287](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/287), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
...
> `037d38ac49ac614302ac099814101ee14241a316`. Continue Issue #282 one
