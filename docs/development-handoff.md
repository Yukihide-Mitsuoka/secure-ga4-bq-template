...
| Active work | ADR-0014 grandchild migration is active in Issue #282. Checkpoints 10–11 advance the direct-parent lock through `b47310e` to `40f914b` as two reviewable commits after merged PR #291, while protecting the direct parent's own foundation lock and decision log. The owner requested batching provenance-only checkpoints to shorten the migration. Next, accept Terraform parent PR #103's owner-qualified overlay, migrate the leaf profile to schema v2, and activate its adapter in a separate contract PR. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
