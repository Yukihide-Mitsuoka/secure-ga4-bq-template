...
| Active work | ADR-0014 grandchild migration is active in Issue #282. PR #284 advances checkpoint 2 to `2634997` after merged PR #283; continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay and migrate the leaf profile to schema v2. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [PR #284](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/284), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
