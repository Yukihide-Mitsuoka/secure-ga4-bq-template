...
| Direct parent lock | `terraform-gcp-template` at `5f3e831f7d92dea92d0d8a5e2640baa10832252e` | [Inheritance lock](../.github/inheritance/lock.json) |
...
| Active work | ADR-0014 grandchild migration is active in Issue #282. Checkpoint 5 advances the lock to `5f3e831` after merged PR #286 while retaining the leaf-owned entry adapter and identity. Continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay, migrate the leaf profile to schema v2, and activate its adapter. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [PR #286](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/286), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
...
> `5f3e831f7d92dea92d0d8a5e2640baa10832252e`. Continue Issue #282 one
