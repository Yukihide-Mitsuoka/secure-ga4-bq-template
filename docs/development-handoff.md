...
|------|---------------------|--------------------|
| Default branch | Release baseline v2.10.0 | [Release v2.10.0](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/releases/tag/v2.10.0) |
| Direct parent lock | `terraform-gcp-template` at `2634997ab014a62645d8ec2b8777d007bc478242` | [Inheritance lock](../.github/inheritance/lock.json) |
...
| Active work | ADR-0014 grandchild migration is active in Issue #282. Checkpoint 2 advances the lock to `2634997` after merged PR #283; continue one first-parent commit per reviewed PR through Terraform parent PR #103, then add the owner-qualified Terraform overlay and migrate the leaf profile to schema v2. Acceptance S remains condition-gated. | [Issue #282](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/issues/282), [PR #283](https://github.com/Yukihide-Mitsuoka/secure-ga4-bq-template/pull/283), [Foundation ADR-0014](foundation/adr/0014-separate-inherited-agent-contracts-from-project-overlays.md), [Inheritance contract](../.github/inheritance/README.md) |
...
> `docs/development-handoff.md`. Confirm the v2.10.0 release baseline and direct-parent lock
> `2634997ab014a62645d8ec2b8777d007bc478242`. Continue Issue #282 one
