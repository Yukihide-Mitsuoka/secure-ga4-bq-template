...
# CHK-01..CHK-11 map to FR-4; additive CHK-12/13 map to FR-9/10.
_CHECK_ID_PATTERN = re.compile(r"^CHK-(0[1-9]|1[0-3])$")
...
class Finding:
    ...
    def __post_init__(self) -> None:
        ...
        if not _CHECK_ID_PATTERN.match(self.check_id):
            raise ValueError(f"check_id must be CHK-01..CHK-13, got {self.check_id!r}")
